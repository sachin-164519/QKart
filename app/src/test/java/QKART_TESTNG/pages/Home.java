...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(
                ...
                ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[contains(@class,'css-yg30e6')]"), product)
            ));
     ...
     * operation
     */
    public Boolean changeProductQuantityinCart(String productName, Double quantity) {
        try {
